...
describe('redux full integration', function () {
  it('reducer receives correct actions', function () {
    ...
    var list2 = void 0,
        ...
        sublist2 = void 0,
        subsublist21 = void 0;
    store.dispatch(list2 = [{ type: "TESTM1", payload: 131 }, actionCreator("TESTM2", 132), { type: "TESTM3", payload: 133 }, sublist1 = [actionCreator("TESTM4", 134), actionCreator("TESTM5", 135)], sublist2 = [subsublist21 = [{ type: "TESTM6", payload: 136 }, { type: "TESTM7", payload: 137 }]]]);
